  ...
  return (
    <div className={styles.container}>
      <div className={styles.airdropClaimBoard}>
        ...
        { canClaim && signedWallet && <Button type="secondary" colorScheme='neutral' label='Claim Tokens' className={styles.airdropClaim} onClick={() => alert('replace with metamask prompt')} /> }
      </div>
      <EmailSubscription />
    </div>
  );
